<div class="bg-center bg-cover mx-auto flex flex-col justify-center items-center h-screen" style="background-image: url('/img/background_intro.webp');">
    <img class="w-32 h-32 rounded-full border-4 border-white" src="/img/perfil.jpg" alt="Foto de Bruno Robson">
    <p class="font-inconsolata subtitle mt-20 text-white">Hello World! Meu nome é Bruno Robson e sou</p>
