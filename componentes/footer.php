...
$contact = [
    [
        ...
        "title" => "Linkedin",
        "link" => "https://www.linkedin.com/in/brunorobson/",
        "alt" => "Linkedin",
    ...
    [
        ...
        "title" => "Instagram",
        "link" => "https://www.instagram.com/bruno.robson10/",
        "alt" => "Instagram",
        "link-logo" => "ph ph-arrow-up-right"
    ],
    [
        "icon" => "ph ph-x-logo",
        "title" => "X",
        "link" => "https://x.com/bruno_robson10",
        "alt" => "X",
        "link-logo" => "ph ph-arrow-up-right"
    ],
    [
        ...
        "title" => "Github",
        "link" => "https://www.github.com/in/brunorobson/",
        "alt" => "GitHub",
        "link-logo" => "ph ph-arrow-up-right"
    ],
    [
        ...
        "title" => "E-mail",
        "link" => "mailto:bruno.appmake@gmail.com",
        "alt" => "E-mail",
        "link-logo" => "ph ph-arrow-up-right"
    ],
];
...
<div class="bg-center bg-cover mx-auto flex flex-col justify-center items-center h-screen" style="background-image: url('/img/background_contacts.webp');">
    <p class="font-inconsolata subtitle mt-20 text-purple-800">Contato</p>
    <h1 class="text-white mt-4 text-bold font-asap title-md">Gostou do meu trabalho? </h1>
